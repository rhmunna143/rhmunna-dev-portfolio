        ...
        <div className="banner-bg  lg:py-16 flex flex-col justify-center items-start">
            <Container>
                <div data-aos="fade-left" className="banner-black p-16 lg:w-4/5">
                    <h1 className="text-5xl font-bold">Hi, I am <span className="uppercase">Rabbi Haque <span className="text-primary">Munna</span></span></h1>
                    ...
                    <div className="random-buttons flex flex-col justify-center w-fit gap-6">
                        <a href={CV} download={"MD_RABBI_HAQUE_MUNNA-Resume.pdf"} className="btn w-fit text-sm mt-6 btn-outline btn-warning md:text-lg font-medium uppercase"><HiOutlineDownload /> Download Resume</a>
                        <div className="icons">
                            <SocialIcons />
                        </div>
                    </div>
